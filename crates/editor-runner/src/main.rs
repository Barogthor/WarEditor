...
fn main() {
    ...
    ini.merge(&path_to_data(prefix, PROFILE_ITEM_FUNC)).unwrap();
    ini.merge(&path_to_data(prefix, PROFILE_HUMAN_ABILITY_FUNC)).unwrap();
    ini.merge(&path_to_data(prefix, PROFILE_ORC_ABILITY_FUNC)).unwrap();
    ini.merge(&path_to_data(prefix, PROFILE_UNDEAD_ABILITY_FUNC)).unwrap();
    ini.merge(&path_to_data(prefix, PROFILE_NIGHT_ELF_ABILITY_FUNC)).unwrap();
    ini.merge(&path_to_data(prefix, PROFILE_NEUTRAL_ABILITY_FUNC)).unwrap();
    ini.merge(&path_to_data(prefix, PROFILE_COMMON_ABILITY_FUNC)).unwrap();
    ini.merge(&path_to_data(prefix, PROFILE_CAMPAIGN_ABILITY_FUNC)).unwrap();
    ini.merge(&path_to_data(prefix, PROFILE_ITEM_ABILITY_FUNC)).unwrap();
    ini.merge(&path_to_data(prefix, PROFILE_HUMAN_UNIT_FUNC)).unwrap();
    ini.merge(&path_to_data(prefix, PROFILE_ORC_UNIT_FUNC)).unwrap();
    ini.merge(&path_to_data(prefix, PROFILE_UNDEAD_UNIT_FUNC)).unwrap();
    ini.merge(&path_to_data(prefix, PROFILE_NIGHT_ELF_UNIT_FUNC)).unwrap();
    ini.merge(&path_to_data(prefix, PROFILE_NEUTRAL_UNIT_FUNC)).unwrap();
    ini.merge(&path_to_data(prefix, PROFILE_CAMPAIGN_UNIT_FUNC)).unwrap();
    ini.merge(&path_to_data(prefix, PROFILE_ITEM_FUNC)).unwrap();
    ini.merge(&path_to_data(prefix, PROFILE_HUMAN_UPGRADE_FUNC)).unwrap();
    ini.merge(&path_to_data(prefix, PROFILE_ORC_UPGRADE_FUNC)).unwrap();
    ini.merge(&path_to_data(prefix, PROFILE_UNDEAD_UPGRADE_FUNC)).unwrap();
    ini.merge(&path_to_data(prefix, PROFILE_NIGHT_ELF_UPGRADE_FUNC)).unwrap();
    ini.merge(&path_to_data(prefix, PROFILE_NEUTRAL_UPGRADE_FUNC)).unwrap();
    ini.merge(&path_to_data(prefix, PROFILE_CAMPAIGN_UPGRADE_FUNC)).unwrap();
    ini.merge(&path_to_data(prefix, PROFILE_UNIT_EDITOR_DATA)).unwrap();
    ini.merge(&path_to_data(prefix, PROFILE_WORLD_EDIT_STRINGS)).unwrap();
    ini.merge(&path_to_data(prefix, PROFILE_WORLD_EDIT_LAYOUT)).unwrap();
    ini.merge(&path_to_data(prefix, PROFILE_WORLD_EDIT_DATA)).unwrap();
    ini.merge(&path_to_data(prefix, PROFILE_WORLD_EDIT_GAME_STRINGS)).unwrap();
    ini.merge(&path_to_data(prefix, PROFILE_WAR3SKINS)).unwrap();
    ini.merge(&path_to_data(prefix, PROFILE_MISC_DATA)).unwrap();
    ini.merge(&path_to_data(prefix, PROFILE_AIEDITOR_DATA)).unwrap();
    ini.fit();
