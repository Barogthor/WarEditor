...
impl ObjectDefinition {
    ...
    pub fn without_optional(reader: &mut BinaryReader, id: ObjectId, game_version: &GameVersion) -> ReadResult<Self> {
        let modif_count = reader.read_u32()?;
        let mut meta_modified = vec![];
        for _i in 0..modif_count {
...
fn read_meta_no_opts(reader: &mut BinaryReader, id: &ObjectId, game_version: &GameVersion) -> ReadResult<MetaModification> {
